    ...
    <div className="bg-white rounded-3xl shadow-lg p-6 md:p-10">
      ...
      <div className="space-y-6">
        {orders.map((order) => (
          <div
            key={order.id}
            className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6 border border-gray-100 rounded-2xl p-6 hover:shadow-xl transition-all duration-300"
          >
